...
#define TASK_THREAD_RA 1856 /* offsetof(struct task_struct, thread.ra) */
#define TASK_THREAD_SP 1864 /* offsetof(struct task_struct, thread.sp) */
#define TASK_THREAD_S0 1872 /* offsetof(struct task_struct, thread.s[0]) */
#define TASK_THREAD_S1 1880 /* offsetof(struct task_struct, thread.s[1]) */
#define TASK_THREAD_S2 1888 /* offsetof(struct task_struct, thread.s[2]) */
#define TASK_THREAD_S3 1896 /* offsetof(struct task_struct, thread.s[3]) */
#define TASK_THREAD_S4 1904 /* offsetof(struct task_struct, thread.s[4]) */
#define TASK_THREAD_S5 1912 /* offsetof(struct task_struct, thread.s[5]) */
#define TASK_THREAD_S6 1920 /* offsetof(struct task_struct, thread.s[6]) */
#define TASK_THREAD_S7 1928 /* offsetof(struct task_struct, thread.s[7]) */
#define TASK_THREAD_S8 1936 /* offsetof(struct task_struct, thread.s[8]) */
#define TASK_THREAD_S9 1944 /* offsetof(struct task_struct, thread.s[9]) */
#define TASK_THREAD_S10 1952 /* offsetof(struct task_struct, thread.s[10]) */
#define TASK_THREAD_S11 1960 /* offsetof(struct task_struct, thread.s[11]) */
#define TASK_THREAD_SP 1864 /* offsetof(struct task_struct, thread.sp) */
...
#define TASK_THREAD_F0 1968 /* offsetof(struct task_struct, thread.fstate.f[0]) */
#define TASK_THREAD_F1 1976 /* offsetof(struct task_struct, thread.fstate.f[1]) */
#define TASK_THREAD_F2 1984 /* offsetof(struct task_struct, thread.fstate.f[2]) */
#define TASK_THREAD_F3 1992 /* offsetof(struct task_struct, thread.fstate.f[3]) */
#define TASK_THREAD_F4 2000 /* offsetof(struct task_struct, thread.fstate.f[4]) */
#define TASK_THREAD_F5 2008 /* offsetof(struct task_struct, thread.fstate.f[5]) */
#define TASK_THREAD_F6 2016 /* offsetof(struct task_struct, thread.fstate.f[6]) */
#define TASK_THREAD_F7 2024 /* offsetof(struct task_struct, thread.fstate.f[7]) */
#define TASK_THREAD_F8 2032 /* offsetof(struct task_struct, thread.fstate.f[8]) */
#define TASK_THREAD_F9 2040 /* offsetof(struct task_struct, thread.fstate.f[9]) */
#define TASK_THREAD_F10 2048 /* offsetof(struct task_struct, thread.fstate.f[10]) */
#define TASK_THREAD_F11 2056 /* offsetof(struct task_struct, thread.fstate.f[11]) */
#define TASK_THREAD_F12 2064 /* offsetof(struct task_struct, thread.fstate.f[12]) */
#define TASK_THREAD_F13 2072 /* offsetof(struct task_struct, thread.fstate.f[13]) */
#define TASK_THREAD_F14 2080 /* offsetof(struct task_struct, thread.fstate.f[14]) */
#define TASK_THREAD_F15 2088 /* offsetof(struct task_struct, thread.fstate.f[15]) */
#define TASK_THREAD_F16 2096 /* offsetof(struct task_struct, thread.fstate.f[16]) */
#define TASK_THREAD_F17 2104 /* offsetof(struct task_struct, thread.fstate.f[17]) */
#define TASK_THREAD_F18 2112 /* offsetof(struct task_struct, thread.fstate.f[18]) */
#define TASK_THREAD_F19 2120 /* offsetof(struct task_struct, thread.fstate.f[19]) */
#define TASK_THREAD_F20 2128 /* offsetof(struct task_struct, thread.fstate.f[20]) */
#define TASK_THREAD_F21 2136 /* offsetof(struct task_struct, thread.fstate.f[21]) */
#define TASK_THREAD_F22 2144 /* offsetof(struct task_struct, thread.fstate.f[22]) */
#define TASK_THREAD_F23 2152 /* offsetof(struct task_struct, thread.fstate.f[23]) */
#define TASK_THREAD_F24 2160 /* offsetof(struct task_struct, thread.fstate.f[24]) */
#define TASK_THREAD_F25 2168 /* offsetof(struct task_struct, thread.fstate.f[25]) */
#define TASK_THREAD_F26 2176 /* offsetof(struct task_struct, thread.fstate.f[26]) */
#define TASK_THREAD_F27 2184 /* offsetof(struct task_struct, thread.fstate.f[27]) */
#define TASK_THREAD_F28 2192 /* offsetof(struct task_struct, thread.fstate.f[28]) */
#define TASK_THREAD_F29 2200 /* offsetof(struct task_struct, thread.fstate.f[29]) */
#define TASK_THREAD_F30 2208 /* offsetof(struct task_struct, thread.fstate.f[30]) */
#define TASK_THREAD_F31 2216 /* offsetof(struct task_struct, thread.fstate.f[31]) */
#define TASK_THREAD_FCSR 2224 /* offsetof(struct task_struct, thread.fstate.fcsr) */
