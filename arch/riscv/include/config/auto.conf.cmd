...
ifneq "$(KERNELVERSION)" "5.2.16"
include/config/auto.conf: FORCE
endif
ifneq "$(CC_VERSION_TEXT)" "riscv64-unknown-linux-gnu-gcc (GCC) 9.2.0"
include/config/auto.conf: FORCE
endif
ifneq "$(CC)" "riscv64-unknown-linux-gnu-gcc"
include/config/auto.conf: FORCE
endif
ifneq "$(LD)" "riscv64-unknown-linux-gnu-ld"
include/config/auto.conf: FORCE
endif
ifneq "$(srctree)" "."
include/config/auto.conf: FORCE
